...
public class AllPatientsFragment extends Fragment {
    ...
    public static List<GetAllPatientDateModel> allPatientDateModels = new ArrayList<>();


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parentView = inflater.inflate(R.layout.fragment_all_patients, container, false);
